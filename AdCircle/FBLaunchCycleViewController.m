...
- (UIView *)launchViewAnimal0
{
    ...
    UIImageView *iv_background2 = imageViewOfAutoScaleImage(@"background4.png");
...
- (UIView *)launchViewAnimal1
{
    ...
    UIImageView *iv_background2 = imageViewOfAutoScaleImage(@"background3.png");
    iv_background2.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    [view addSubview:iv_background2];
...
- (UIView *)launchViewAnimal2
{
    ...
    UIImageView *iv_background2 = imageViewOfAutoScaleImage(@"background2.png");
    iv_background2.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    [view addSubview:iv_background2];
...
- (UIView *)launchViewAnimal3
{
    ...
    UIImageView *iv_background2 = imageViewOfAutoScaleImage(@"background5.png");
    iv_background2.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    [view addSubview:iv_background2];
